...
class StaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stay" do
    assert_difference('Stay.count') do
      post stays_url, params: { stay: { client_id: @stay.client_id, rate_id: @stay.rate_id, room_id: @stay.room_id } }
    end
  ...
  test "should update stay" do
    patch stay_url(@stay), params: { stay: { client_id: @stay.client_id, rate_id: @stay.rate_id, room_id: @stay.room_id } }
